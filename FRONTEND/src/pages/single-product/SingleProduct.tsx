            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="mb-4">
                <span className="font-bold text-gray-700 dark:text-gray-300">
                  Product Category:{" "}
                  <p className="font-normal inline-block">{product?.Category.categoryName}</p>
                </span>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">
                  ...
                  blandit. Quisque ut erat vitae nisi ultrices placerat non eget velit. Integer
                  ornare mi sed ipsum lacinia, non sagittis mauris blandit. Morbi fermentum libero
                  vel nisl suscipit, nec tincidunt mi consectetur.
                </p>
              </div>
            </div>
          </div>
