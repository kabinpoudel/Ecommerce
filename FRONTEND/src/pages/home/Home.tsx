        ...
        <main className="text-gray-900">
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      An enim nullam tempor gravida donec enim ipsum blandit porta justo integer
                      odio velna vitae auctor integer.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
            ...
            <div className="container mx-auto px-16 items-center flex flex-col lg:flex-row">
              <div className="lg:w-1/2">
                <div className="lg:pr-32 xl:pr-48">
                  ...
                  <p className="mt-8 text-xl font-light leading-relaxed">
                    Our team of enthusiastic marketers will analyse and evaluate how your company
              ...
              <div className="mt-10 lg:mt-0 w-full lg:w-1/2 undefined">
                ...
                >
                  ...
                  <ellipse cx="193.5" cy="750.89" rx="57.01" ry="10.96" fill="#4299e1"></ellipse>
                  <ellipse cx="192.55" cy="746.23" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="735.61" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="724.99" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="714.37" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="703.75" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="693.13" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <ellipse cx="192.55" cy="682.51" rx="6.64" ry="8.69" fill="#3f3d56"></ellipse>
                  <path
              ...
              <div className="flex flex-col md:flex-row md:-mx-3">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-6">
                      Eu lobortis elementum nibh tellus molestie nunc non blandit massa. Sit amet
          ...
          <section className="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
            ...
            <p className="mt-8 text-xl font-light">
              Quis lectus nulla at volutpat diam ut. Enim lobortis scelerisque fermentum dui
              faucibus in.
            </p>
            <p className="mt-8">
              <button
